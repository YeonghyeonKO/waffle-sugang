...
def download_survey():
    ...
    path = 'C://Users//kyh//GitHub//waffle-rookies-18.5-backend-2//waffle_backend'  # NOTE: you should assign proper directory path
    if not path:
    ...
    with open(tsv_file, encoding='UTF8') as f:
